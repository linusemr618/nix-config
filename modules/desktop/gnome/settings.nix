  ...
  flake.homeModules.desktop = {lib, ...}:
    with lib.hm.gvariant; {
      dconf.settings = {
        ...
        "org/gnome/shell".favorite-apps = ["brave-browser.desktop" "org.gnome.Nautilus.desktop" "org.gnome.Console.desktop" "org.gnome.TextEditor.desktop" "code.desktop" "pycharm.desktop"];
